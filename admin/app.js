...
function renderPalsExisting() {
  return `
    <section class="panel chart-panel">
      ...
      <div class="hbar-chart pals-chart">
        ${palsRows.map(([name,,,, completion], index) => `
          <div class="hbar-label" style="grid-row:${index + 1}">${name.replace(" ", "<br>")}</div>
          <div class="hbar-track" style="grid-row:${index + 1}"><span class="teal" style="--value:${completion}%"></span></div>
        `).join("")}
        <div class="axis axis-0">0%</div><div class="axis axis-25">25%</div><div class="axis axis-50">50%</div><div class="axis axis-75">75%</div><div class="axis axis-100">100%</div>
      </div>
    </section>
